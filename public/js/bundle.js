...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidmFpYmhhdi12ZXJtYSIsImEiOiJjbDA2YmVrbGYwYnN3M2RyMmZleWc0Z3pnIn0.32mk8SOlP1tHmXmpNy4yyQ';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/vaibhav-verma/cl06cmzgf004e16p9714nfsbq',
    // style URL
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); //Extends map bounds to include currrent location
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "11494" + '/');
